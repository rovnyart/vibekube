...
| 9 | [Workload Debugging Basics](PHASE9.md) | Started | Workload Overview includes an event-aware debug summary for common unhealthy signals with quick jumps to Events, Logs, Containers, Env, and YAML |
...
- [x] See event-aware workload debug summaries for common unhealthy signals.
