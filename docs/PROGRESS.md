...
| 9 | [Workload Debugging Basics](PHASE9.md) | Started | Workload Overview includes event-aware debug summaries, scheduling/QoS context, selector-backed Pod rollups, and quick jumps to Events, Logs, Containers, Env, and YAML |
...
1. Continue the read-only workload debugging track with CronJob-to-Job-to-Pod rollups or start port-forward sessions.
...
- [x] See selector-backed workload Pod rollups in resource details.
