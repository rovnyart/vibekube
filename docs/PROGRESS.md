...
| 3 | [Main App Shell](PHASE3.md) | Review checkpoint | NavigationSplitView shell has persisted top-level cluster/resource route state, grouped nav, toolbar controls, placeholders, and basic shortcuts |
