...
| 12 | [AI Foundations](PHASE12.md) | In progress | Provider settings, Keychain secret storage, model discovery, provider transport tests, redacted resource context, resource-scoped AI explain chat, visual gating QA, and manual AI evaluation checklist are in place |
...
1. Continue Phase 12 by running provider-backed manual AI evaluation with a real test key/model.
