...
1. Finish Phase 11 release/security hardening for the read-only milestone: clean-machine validation, sandbox/credential-storage decisions, exec-auth/API-client confidence, and released-DMG verification.
